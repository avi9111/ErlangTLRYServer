%% -*- coding: latin-1 -*-
%%------------------------------------------------------------------------------
%% @File   : conf_filter_name
%% @Brief  : 名字过滤
%% @Author : Ryuu
%%------------------------------------------------------------------------------
-module(conf_filter_name).
...
words() ->
    [
        ...
        <<"英雄“岱崮连”">>,
        <<"血战大鱼山岛四十二烈士">>,
        <<"抗日外交九烈士（1942）国民政府驻菲律宾马尼拉和北婆罗洲山打根外交使节">>,
        <<"英雄“岱崮连”（1943）八路军鲁中军区第2军分区11团8连">>,
        <<"血战大鱼山岛四十二烈士（1944）新四军浙东纵队海防大队1中队">>,
        <<"汪东波">>,
        <<"吴荣富">>,
        <<"陈爱中">>,
        <<"杨思忠">>,
